...
const responsiveMockups = [
  {
    title: "PC",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-main-pc.png"),
    alt: "서울시립청소년센터 메인 PC UI 디자인",
    note: "1440px 기준 메인 최종 UI 전체 프레임. 헤더, 비주얼, 퀵메뉴, 모집 중 프로그램, 맞춤 탐색, 일정, 공지, 활동사진, SNS, 푸터까지 포함",
  },
  {
    title: "Tablet",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-main-tablet.png"),
    alt: "서울시립청소년센터 메인 태블릿 UI 디자인",
    note: "태블릿 메인 최종 UI 전체 프레임. PC의 핵심 콘텐츠가 태블릿 화면에서 어떻게 재배치되는지 보이도록 전체 흐름 포함",
  },
  {
    title: "Mobile",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-main-mobile.png"),
...
const uiDetailImages = [
  {
    title: "Program Cards",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-program-cards.png"),
    alt: "모집 중 프로그램 카드 UI",
    note: "모집 중인 청소년 프로그램 카드 영역 크롭. 포스터, 접수 상태, 제목, 기간, 태그가 한 화면에 보이도록 포함",
  },
  {
    title: "Personalized Search",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-personalized-search.png"),
    alt: "나에게 맞는 프로그램 살펴보기 UI",
    note: "연령 기준과 분야 기준 필터, 청소년/평생교육 프로그램 결과 영역이 함께 보이도록 크롭",
  },
  {
    title: "Activity & SNS",
    src: getPublicAssetPath("images/projects/seoul-youth-center/ui-activity-sns.png"),
    alt: "활동사진과 SNS UI",
