...
<header>
    <!-- Logo -->
    <h1 class="logo font-brand"><a href="index.php">FRAGFARM</a></h1>
    <!-- Main Menu -->
    ...
    <nav class="header__gnb" id="gnb">
        <ul class="gnb__list">
            <li class="gnb__item">
                <a class="gnb__link" href="about.php">about us</a>
            </li>
            <li class="gnb__item">
                <a class="gnb__link" href="product.php">SHOP</a>
            </li>
            <li class="gnb__item">
            ...
            <li class="gnb__item gnb__item--has-sub">
                <button class="gnb__toggle" 
                    ...
                    season book
                    <img class="toggle-btn" src="assets/icons/expand.svg" alt="" aria-hidden="true">
                </button>
            ...
            <li class="gnb__search">
                ...
                <div class="search__bar">
                    <input class="search__input" type="search" name="q" id="search" placeholder="What are you looking for?">
...
<script>
    ...
    if (menuButton && mobileMenu && iconOpen && iconClosed) {
        ...
        document.addEventListener('keydown', (e) => {
            if (e.key === 'Escape') {
                const isOpen = menuButton.getAttribute('aria-expanded') === 'true';
                if (!isOpen) return; //닫힌 상태에서 esc 눌렀는데 열리면 이상하니까

                setMenuState(false); //닫기 초기화
                menuButton.focus(); //접근성
            }
        });
    }
